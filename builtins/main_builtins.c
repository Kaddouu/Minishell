...
/*   Updated: 2025/03/07 14:54:16 by ilkaddou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_echo(void)
{
	...
	fflush(stdout);
	ft_echo(args2);
	printf("\n");  // Pour visualiser le résultat sans newline
...
void	test_exit_info(void)
{
	...
	printf("1. ft_exit([\"exit\", NULL]) - Sortie avec code 0\n");
	printf("2. ft_exit([\"exit\", \"42\", NULL]) - Sortie avec code 42\n");
	printf("3. ft_exit([\"exit\", \"abc\", NULL]) - Sortie avec code 255 (argument non numérique)\n");
	fflush(stdout);
}
